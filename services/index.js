...
export const register_user = async (formData) => {
    try {
        const res = await fetch('http://intelicitynxmeta-production.up.railway.app/api/Auth/register', {
            headers: {
...
export const login_user = async (formData) => {
    try {
        const res = await fetch('http://intelicitynxmeta-production.up.railway.app/api/Auth/login', {
            headers: {
                'Content-Type': 'application/json',
            },
            method: 'POST',
